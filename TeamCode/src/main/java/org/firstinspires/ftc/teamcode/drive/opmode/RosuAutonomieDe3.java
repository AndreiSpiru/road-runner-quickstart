...
public  class RosuAutonomieDe3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        phoneCam.setPipeline(new RosuAutonomieDe3.StageSwitchingPipeline());//different stages
    ...
    public void vaj(int direction,double time)
    {
        ...
        while(runtime.time(TimeUnit.MILLISECONDS)<=time) {
            if(direction == 1)fnd1.setPower(-0.3);
    ...
    public static class StageSwitchingPipeline extends OpenCvPipeline
    {
        ...
        public RosuAutonomieDe3.StageSwitchingPipeline.Stage stageToRenderToViewport = RosuAutonomieDe3.StageSwitchingPipeline.Stage.detection;
        public RosuAutonomieDe3.StageSwitchingPipeline.Stage[] stages = RosuAutonomieDe3.StageSwitchingPipeline.Stage.values();
